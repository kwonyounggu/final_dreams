...
final List<StudyTopic> myInterests = [
  StudyTopic(
    ...
    description: 'Reflections on impermanence, mindfulness, and the middle way.',
  ),
  StudyTopic(
    title: 'Quantum Mechanics',
    icon: Icons.science,
    description: 'Notes on wavefunctions, measurement, and quantum reality.',
  ),
  StudyTopic(
    title: 'Vision Science',
    icon: Icons.remove_red_eye,
    description: 'Exploring visual perception, models of attention, and neural processing.',
  ),
  StudyTopic(
    title: 'Apps',
    icon: Icons.apps,
    description: 'Mobile applications I’ve built and am working on.',
  ),
];
